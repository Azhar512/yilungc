  ...
  const commonFilters = [
    {
      ...
      status: {
        ...
        equals: "Ready for publish", // Corrected to lowercase 'p' based on screenshot
      },
    },
  ]
  ...
  if (category === "book-reviews") {
    filter = {
      or: [
        ...
        {
          property: "讀書心得", // Changed to actual multi-select property name
          multi_select: {
            contains: "讀書心得", // Filter for multi-select
          },
        },
        {
          property: "讀書心得",
    ...
    filter = {
      or: [
        ...
        {
          property: "人生其他", // Changed to actual multi-select property name
          multi_select: {
            contains: "看房紀錄", // Filter for multi-select
          },
        },
        {
          property: "人生其他",
